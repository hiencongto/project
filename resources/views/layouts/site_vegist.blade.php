...
<!-- Mirrored from spacingtech.com/html/vegist-final/vegist/index1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 07:37:00 GMT -->
...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" type="image/favicon" href="{{asset('vegist/image/fevicon.png')}}">
    <!-- bootstrap -->
    <link rel="stylesheet" type="text/css" href="vegist/css/bootstrap.min.css">
    <!-- simple-line icon -->
    <link rel="stylesheet" type="text/css" href="vegist/css/simple-line-icons.css">
    <!-- font-awesome icon -->
    <link rel="stylesheet" type="text/css" href="vegist/css/font-awesome.min.css">
    <!-- themify icon -->
    <link rel="stylesheet" type="text/css" href="vegist/css/themify-icons.css">
    <!-- ion icon -->
    <link rel="stylesheet" type="text/css" href="vegist/css/ionicons.min.css">
    <!-- owl slider -->
    <link rel="stylesheet" type="text/css" href="vegist/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="vegist/css/owl.theme.default.min.css">
    <!-- swiper -->
    <link rel="stylesheet" type="text/css" href="vegist/css/swiper.min.css">
    <!-- animation -->
    <link rel="stylesheet" type="text/css" href="vegist/css/animate.css">
    <!-- style -->
    <link rel="stylesheet" type="text/css" href="vegist/css/style.css">
    <link rel="stylesheet" type="text/css" href="vegist/css/responsive.css">
</head>
                    ...
                    <li class="top-home-li">
                        ...
                        <div class="currency">
                            ...
                            <div class="currency-drop">
                                <div class="eur">
                                    <img class="img-fluid" src="vegist/image/c-icon1.png" alt="">
                                    <span class="cur-name">EUR</span>
                                </div>
                                <ul class="all-currency">
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon4.png" alt="">
                                            <span class="cur-name">AFN</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon2.png" alt="">
                                            <span class="cur-name">BDT</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon3.png" alt="">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon5.png" alt="">
                                            <span class="cur-name">GBP</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon6.png" alt="">
                                            <span class="cur-name">INR</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon7.png" alt="">
                                            <span class="cur-name">SAR</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <img class="img-fluid" src="vegist/image/c-icon8.png" alt="">
                ...
                <div class="col">
                    <div class="header-main">
                        ...
                        <div class="header-element logo">
                            <a href="{{route('home')}}">
                                <img src="vegist/image/logo1.png" alt="logo-image" class="img-fluid">
                            </a>
                        </div>
                        <!-- logo end -->
                        <!-- search start -->
                                ...
                                <li class="side-wrap user-wrap">
                                    <div class="acc-desk">
                                        ...
                                        <div class="user-info">
                                            ...
                                            @else
                                                <a><span class="acc-title">{{$user['name']}}</span></a>
                                            @endif
...
{{--                                                @else--}}
                                                    ...
                                                    <a href="{{route('loginuser')}}">Log in</a>
{{--                                                @endif--}}
                                            </div>
                                        </div>
                                    </div>
...
{{--                                                        </li>--}}
                                                ...
                                                <li class="menu-link parent">
                                                    ...
                                                    <ul class="dropdown-submenu banner-menu collapse" id="collapse-banner-menu">
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="vegist/image/menu-banner01.jpg" alt="menu-image" class="img-fluid"></a>
                                                            <a href="grid-list.html" class="menu-banner-title"><span>Bestseller</span></a>
                                                        </li>
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="vegist/image/menu-banner02.jpg" alt="menu-image" class="img-fluid"></a>
                                                            <a href="grid-list.html" class="menu-banner-title"><span>Special product</span></a>
                                                        </li>
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="vegist/image/menu-banner03.jpg" alt="mneu image" class="img-fluid"></a>
                                ...
                                <div class="img-hotline">
                                    <div class="image-line">
                                        <a href="javascript:void(0)"><img src="vegist/image/icon_contact.png" class="img-fluid" alt="image-icon"></a>
                                    </div>
    ...
    <div class="mini-cart">
        ...
        <ul class="cart-item-loop">
            <li class="cart-item">
                <div class="cart-img">
                    <a href="product.html">
                        <img src="vegist/image/cart-img.jpg" alt="cart-image" class="img-fluid">
                    </a>
                </div>
            ...
            <li class="cart-item">
                <div class="cart-img">
                    <a href="product.html">
                        <img src="vegist/image/cart-img02.jpg" alt="cart-image" class="img-fluid">
                    </a>
                </div>
                <div class="cart-title">
            ...
            <li class="cart-item">
                <div class="cart-img">
                    <a href="product.html">
                        <img src="vegist/image/cart-img03.jpg" alt="cart-image" class="img-fluid">
                    </a>
                </div>
                <div class="cart-title">
            ...
            <li class="cart-item">
                <div class="cart-img">
                    <a href="product.html">
                        <img src="vegist/image/cart-img04.jpg" alt="cart-image" class="img-fluid">
                    </a>
                </div>
                <div class="cart-title">
...
<section class="news-letter1">
    <div class="section-tb-padding news-img" style="background-image: url(vegist/image/banner3.jpg);">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="home-news">
            ...
            <div class="col">
                <div class="brand-carousel owl-carousel owl theme">
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l1.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l2.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l3.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l4.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l5.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l6.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l7.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="items">
                        <div class="brand-img">
                            <a href="javascript:void(0)">
                                <img src="vegist/image/brand/home-123/l8.png" alt="home brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="f-logo">
                    <ul class="footer-ul">
                        <li class="footer-li footer-logo">
                            <a href="index1.html">
                                <img class="img-fluid" src="vegist/image/logo1.png" alt="">
                            </a>
                        </li>
            ...
            <div class="col">
                <ul class="f-bottom">
                    ...
                    <li class="f-c f-payment">
                        <a href="checkout-1.html"><img src="vegist/image/payment.png" class="img-fluid" alt="payment image"></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="popup-content">
                    ...
                    <div class="pop-up-newsletter" style="background-image: url(vegist/image/news-popup.jpg);">
                        <div class="logo-content">
                            <a href="index1.html"><img src="vegist/image/logo1.png" alt="image" class="img-fluid"></a>
...
<!-- jquery -->
<script src="vegist/js/modernizr-2.8.3.min.js"></script>
<script src="vegist/js/jquery-3.6.0.min.js"></script>
<!-- bootstrap -->
<script src="vegist/js/bootstrap.min.js"></script>
<!-- popper -->
<script src="vegist/js/popper.min.js"></script>
<!-- fontawesome -->
<script src="vegist/js/fontawesome.min.js"></script>
<!-- owl carousal -->
<script src="vegist/js/owl.carousel.min.js"></script>
<!-- swiper -->
<script src="vegist/js/swiper.min.js"></script>
<!-- custom -->
<script src="vegist/js/custom.js"></script>
</body>

<!-- Mirrored from spacingtech.com/html/vegist-final/vegist/index1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 07:38:36 GMT -->
</html>
