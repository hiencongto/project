...
<!-- Mirrored from transvelo.github.io/mediacenter-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 02:42:46 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/bootstrap.min.css')}}">

    <!-- Customizable CSS -->
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/colors/green.css')}}">
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/owl.transitions.css')}}">
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/animate.min.css')}}">

    <!-- Demo Purpose Only. Should be removed in production -->
    <link rel="stylesheet" href="{{asset('demo_crud/assets/css/config.css')}}">

    <link href="demo_crud/assets/css/colors/green.css" rel="alternate stylesheet" title="Green color">
    <link href="demo_crud/assets/css/colors/blue.css" rel="alternate stylesheet" title="Blue color">
    <link href="demo_crud/assets/css/colors/red.css" rel="alternate stylesheet" title="Red color">
    <link href="demo_crud/assets/css/colors/orange.css" rel="alternate stylesheet" title="Orange color">
    <link href="demo_crud/assets/css/colors/navy.css" rel="alternate stylesheet" title="Navy color">
    <link href="demo_crud/assets/css/colors/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
    ...
    <!-- Icons/Glyphs -->
    <link rel="stylesheet" href="demo_crud/assets/css/font-awesome.min.css">

    <!-- Favicon -->
    <link rel="shortcut icon" href="demo_crud/assets/images/favicon.ico">

    <!-- HTML5 elements and media queries Support for IE8 : HTML5 shim and Respond.js -->
    <!--[if lt IE 9]>
    <script src="demo_crud/assets/js/html5shiv.js"></script>
    <script src="demo_crud/assets/js/respond.min.js"></script>
    <![endif]-->
</head>
    ...
    <header class="no-padding-bottom header-alt">
        <div class="container no-padding">
            <div class="col-xs-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="index.html">
                        <!--<img alt="logo" src="public/demo_crud/assets/images/logo.svg" width="233" height="54"/>-->
                        <!--<object id="sp" type="image/svg+xml" data="public/demo_crud/assets/images/logo.svg" width="233" height="54"></object>-->
                        ...
                        <div class="basket">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <div class="basket-item-count">
                                    ...
                                    <img src="{{asset('demo_crud/assets/images/icon-cart.png')}}" alt="" />
                                </div>
                                    ...
                                    <div class="basket-item">
                                        <div class="row">
                                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                <div class="thumb">
                                                    <img alt="" src="{{asset('demo_crud/assets/images/products/product-small-01.jpg')}}" />
                                                </div>
                                            </div>
                        ...
                        <ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="{{asset('demo_crud/assets/images/blank.gif')}}"
                                                 data-echo="demo_crud/assets/images/products/product-small-01.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-02.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-03.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-04.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-05.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-06.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-07.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-08.jpg"/>
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="demo_crud/assets/images/blank.gif"
                                                 data-echo="demo_crud/assets/images/products/product-small-09.jpg"/>
                                        </a>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="demo_crud/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="demo_crud/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="demo_crud/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="demo_crud/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<script src="{{asset('demo_crud/assets/js/jquery-1.10.2.min.js')}}"></script>
<script src="{{asset('demo_crud/assets/js/jquery-migrate-1.2.1.js')}}"></script>
<script src="{{asset('demo_crud/assets/js/bootstrap.min.js')}}"></script>
<script
    src="http://maps.google.com/maps/api/js?key=AIzaSyDDZJO4F0d17RnFoi1F2qtw4wn6Wcaqxao&amp;sensor=false&amp;language=en"></script>
<script src="demo_crud/assets/js/gmap3.min.js"></script>
<script src="demo_crud/assets/js/bootstrap-hover-dropdown.min.js"></script>
<script src="demo_crud/assets/js/owl.carousel.min.js"></script>
<script src="demo_crud/assets/js/css_browser_selector.min.js"></script>
<script src="demo_crud/assets/js/echo.min.js"></script>
<script src="demo_crud/assets/js/jquery.easing-1.3.min.js"></script>
<script src="demo_crud/assets/js/bootstrap-slider.min.js"></script>
<script src="demo_crud/assets/js/jquery.raty.min.js"></script>
<script src="demo_crud/assets/js/jquery.prettyPhoto.min.js"></script>
<script src="demo_crud/assets/js/jquery.customSelect.min.js"></script>
<script src="demo_crud/assets/js/wow.min.js"></script>
<script src="demo_crud/assets/js/buttons.js"></script>
<script src="demo_crud/assets/js/scripts.js"></script>

<!-- For demo purposes – can be removed on production -->
<script src="demo_crud/switchstylesheet/switchstylesheet.js"></script>
...
<!-- Mirrored from transvelo.github.io/mediacenter-html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 02:42:47 GMT -->
</html>
